...
export default async function page({ searchParams }: SearchParams) {
  ...
  const readings = await GetReadingsGraph({ roomId: currentFirstRoom, indicator, unit, date_after: formattedDateAfter, date_before: formattedDateBefore, hour_after: start, hour_before: end, token: authToken! })
