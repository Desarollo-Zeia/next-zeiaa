...
export default async function page({ searchParams } : SearchParams) {
  ...
  const readings = await readingsGraph({ roomId: currentFirstRoom, indicator, unit, date_after: format(date_after,"yyyy-MM-dd"), date_before: format(date_before, "yyyy-MM-dd"), hour_after: start, hour_before: end})
