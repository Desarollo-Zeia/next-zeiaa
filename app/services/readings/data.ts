...
export async function readingsCovid({ roomId, indicator, unit, date_after, date_before, page, token }: { roomId?: string | number, indicator: string, unit: string, date_after?: string, date_before?: string, page: string, token?: string }) {
...
export async function readingsCovidBaselines({ roomId, date_after, date_before, token }: { roomId?: string | number, date_after?: string, date_before?: string, token?: string }) {
...
export async function readingsCovidDetail({ date, page, roomId, hour_before, hour_after, risk, token }: { date?: string, page?: string, roomId?: string | number, hour_before?: string, hour_after?: string, risk?: string, token?: string }) {
...
export async function riskReached({ roomId, date, token }: { roomId?: string | number, date?: string, token?: string }) {
