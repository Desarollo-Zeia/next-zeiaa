...
export async function consumeGraph({ headquarterId = '1', panelId = '1', date_after, date_before, indicador = 'Uab'} : { date_after?: string,  date_before?: string, panelId?: string, headquarterId?: string, indicador?: string}) {
