...
export async function armonics({ headquarterId, panelId, date_after, date_before, data_type} : { date_after?: string,  date_before?: string, panelId?: string, headquarterId?: string, data_type?:string}) {
